...
def extractFile1(imageFile,filenames):
...
def image_handle1(imageFile, sha1Hash):
...
def image_handle2(imageFile, sha1Hash):
...
dic1 = image_handle1(args.imagefile1, sha1Hash1)
dic2 = image_handle2(args.imagefile2, sha1Hash2)
...
extractFile1(args.imagefile1, v)

extractFile2(args.imagefile2, v)
